...
namespace ServiceRest_20190140037_AnnisaRisyafa
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=LAPTOP-07EGJ8M5\\SQLEXPRESS01;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=annisa16");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=LAPTOP-07EGJ8M5\\SQLEXPRESS01;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=annisa16");
